...
public class TigerParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class CompareChainContext extends CompExprContext {
		...
		public CompareChainContext(CompExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TigerListener ) ((TigerListener)listener).enterCompareChain(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TigerListener ) ((TigerListener)listener).exitCompareChain(this);
		}
	}
	...
	public final CompExprContext compExpr() throws RecognitionException {
		...
		int _la;
		try {
			_localctx = new CompareChainContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(251);
			addExpr();
