...
2. Download `ANTLR-4.12.0` to the current directory
```
...
$ alias grun='java -Xmx500M -cp "./antlr-4.12.0-complete.jar:./build:$CLASSPATH" org.antlr.v4.gui.TestRig'
# Windows:
$ alias antlr4='java -Xmx500M -cp "./antlr-4.12.0-complete.jar\;$CLASSPATH" org.antlr.v4.Tool'
$ alias grun='java -Xmx500M -cp "./antlr-4.12.0-complete.jar\;./build\;$CLASSPATH" org.antlr.v4.gui.TestRig'
```
...
```bash
# UNIX-based platforms
$ javac -cp "./antlr-4.12.0-complete.jar:$CLASSPATH" ./antlr_generated/Expr*.java -d ./build
# Windows
$ javac -cp "./antlr-4.12.0-complete.jar\;$CLASSPATH" ./antlr_generated/Expr*.java -d ./build
```
